...
models <-read.table(file=paste0(id,"_2_species_for_FigS7.txt"),header=T,sep="\t")
dats <-read.table(file=paste0(id,"_1_species_for_FigS7.txt"),header=T,sep="\t")
...
ggsave("figS7_panelA.pdf",p,width = 12, height = 10, units = "cm") 
...
ggsave("figS7_panelB.pdf",p,width = 12, height = 10, units = "cm") 
